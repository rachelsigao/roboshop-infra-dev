...
# Creating the EC2 instance for catalogue.
...
# Installing catalogue application on the EC2 instance.
...
# Creating the Auto Scaling group for catalogue to automatically scale the EC2 instances based on the demand. 
